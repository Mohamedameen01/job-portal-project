    ...
    <div>
      ...
      <div className="grid xl:grid-cols-2 gap-3 mt-4">
        <div className="my-2 bg-white rounded-md shadow-md">
          <h2 className="my-3 mx-4 font-semibold">Your Profile Views</h2>
        ...
        <div className="my-2 bg-white rounded-md shadow-md">
          ...
          {notifyData.map((item, index) => (
            <div className="mx-4 py-2 flex items-center gap-2" key={index}>
              <div
              ...
              <div className="flex flex-wrap gap-1">
                ...
                <p className="text-sm text-slate-600">applied for a job</p>
                <p
